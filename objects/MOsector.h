...
public:
    MOsector(float x, float y, float radius, float start_angle, float end_angle, float r1_len, float r2_len, float r, float g, float b)
    : figure_selfmade(x, y, r, g, b),      // 1. Корень всей графики
      ...
      msector(x, y, radius, start_angle, end_angle, r1_len, r2_len, r, g, b), // 4. Прямой родитель
      object() {
        draw();
